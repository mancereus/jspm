var data1 = {
    ...
    initcards: [
        ...
        { name: "Höhle", Aktion: "Wenn man die Fackel besitzt, kann man von dieser Höhle direkt zu einer anderen Höhlenkarte ziehen. Die Fackel darf man behalten.", ver: true, info: "info" },
        { name: "Höhle", Aktion: "Wenn man die Fackel besitzt, kann man von dieser Höhle direkt zu einer anderen Höhlenkarte ziehen. Die Fackel darf man behalten.", ver: true, info: "info" },
        { name: "Schlucht", info: "problem", Aktion: "Die Schlucht kannst du nicht geradeaus überqueren. Du musst in der Bewegung abbiegen." },
        { name: "Schlucht", info: "problem", Aktion: "Die Schlucht kannst du nicht geradeaus überqueren. Du musst in der Bewegung abbiegen." },
    ...
    initActions: [
       ...
       { name: "Traum", order: "announcement", Aktion: "Jane hat einen mysteriösen Traum. Im Tempel findet Sie mit der Fackel und dem Tagebuch den Weg zum Tal der Kanibalen. Legt die Fackel dort ab, dann kennt ihr den Weg zum 'Tal der Kannibalen'.", task: true },
        ...
        { name: "Menschenaffe", order: "star", Aktion: "Jane wird von einem Menschenaffen angegriffen aber im letzten Moment vom Jäger Stoephasius gerettet. Er will sich euch anschliessen, aber Jack weist ihn wütend zurück. Stoephasius verlässt euch mit den Worten: 'Das wird euch noch leid tun.' Akt 2 mit 'Jäger'", task: true },
        { name: "Karte", Aktion: "Du findest eine Karte des Dschungels. Ab sofort kannst du Karten auch diagonal anlegen.", task: true },
        { name: "Fluss", order: "home", orderText: "Ausgang", Aktion: "Wenn ihr den Weg zum 'Tal der Kannibalen' kennt, könnt ihr mit dem Boot über den Fluss dorthin fahren und den Akt 1 erfolgreich beenden. Lest dann die Karte 'Akt 1 Ende'", task: true },
