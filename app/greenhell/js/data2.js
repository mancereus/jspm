var data2 = {
  ...
  initcards: [
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jane: 'Was war das für ein Geräusch?'",
      hor: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jack: 'Prof. Hampton ist vermutlich schon tot.' Jane: 'Nein, er lebt noch.'",
      hor: true
    },
    {
      name: "Gang",
    ...
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jack: 'Hier ist erst vor kurzem jemand vorbeigekommen.'",
      ver: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jane: 'Wir brauchen mehr Wasser zum Trinken.'",
      ver: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jack: 'Wir sollten umkehren.'",
      ver: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jane: 'DIeser Gang wurd künstlich angelegt..'",
      ver: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jack: 'Hier geht es nicht weiter.'",
      ver: true,
      hor: true
    },
    {
      name: "Gang",
      Aktion: "",
      flavour: "Jane: 'Hier sind sehr ungewöhnliche Schriftzeichen.'",
      ver: true,
      hor: true
    },
    {
    ...
    {
      name: "Geheimgang",
      Aktion: "Wenn man eine Fackel besitzt, kann man von diesem Geheimgang direkt zu einem anderen Geheimgang ziehen. Die Fackel darf man behalten.",
      hor: true,
      info: "info"
    },
    {
    ...
    {
      name: "Gesteinswand",
      Aktion: "Hier ist massiver Fels. Du kannst dieses Feld nicht betreten.",
      info: "problem"
    },
    {
      name: "Gesteinswand",
    ...
    {
      name: "Schrumpfkopf",
      Aktion: "Ihr findet einen Schrumpfkopf der Kannibalen.",
      hor: true,
      imgclass: "symbol"
    },
    {
      name: "Dynamit",
      Aktion: "Du findest einen versteckten Vorrat an Dynamit und kannst damit eine Gesteinswand sprengen. Lege dazu das Dynamit und eine Fackel von einem Nachbarfeld aus ohne Wand dazwischen auf die Gesteinswand.",
      imgclass: "symbol"
    },
    {
      name: "Artefakt",
      Aktion: "Du findest ein Artefakt einer unbekannten Zivilisation. ",
      imgclass: "symbol",
      hor: true
    },
    {
    ...
    {
      name: "Spinne",
      Aktion: "Riesige Spinnen blockieren hier den Durchgang. Du kannst nicht geradeausgehen, sondern nur abbiegen. Lege eine Fackel hier ab, um die Spinne zu verbrennen.",
      info: "problem"
    },
    {
      name: "Spinne",
    ...
    },
    {
      name: "Felsfalle",
      info: "event",
      Aktion: "Lass die Karte aus Kopfhöhe auf den Tisch fallen. Landet Sie mit dieser Seite nach oben, löst ihr eine Falle aus. Legt die Karte auf das Feld eurer Figur und zieht mit eurere Figur innerhalb von 5 Sekunden auf ein benachbartes erreichbares Feld. Dieses Feld ist nicht mehr betretbar.",
      info: "event"
    },
    {
      name: "Überfall",
      info: "event",
      Aktion: "Jack kommt von einer Suche zurück und Jane ist verschwunden. Er findet Spuren eines Kampfes. Lege Janes Inventarkarte zur Seite.Verwende in Akt 3 eine Aktionskarte mit 'Jane'"
    },
    {
      name: "Leiche",
      info: "event",
  ...
  initActions: [
    ...
    //   order: "build",
    //   orderText: "Jack",
    //   Aktion: "Jack wird von den Kannibalen überrascht und gefangen. Jane muss den Kannibalen den Schrumpfkopf geben, dann lassen sie Jack frei. Bis dahin kannst du Jacks Inventarkarte nicht verwenden. Ist auch Jane gefangen, dann ist das Abenteuer nun beendet.",
    //   task: true
    // },
    ...
    //   order: "gesture",
    //   orderText: "Jane",
    //   Aktion: "Jane wird von den Kannibalen als Dschungelkönigin verehrt. Lege mit der Fackel ein Feuer, dann kann Jane unbemerkt fliehen. Jane erzählt dir von einer geheimen Schatzkammer der Kannibalen. Die Fackel geht in den Vorrat.",
    //   task: true
    // },
    // {
    //   name: "Befreit",
