var data2 = {
    ...
    initcards: [
        ...
        {name: "Hängebrücke", Aktion: "Die Hängebrücke kannst du mit vollem Inventar nicht überqueren. Lege Dinge dazu auf ihr Feld zurück." ,type: "Basiskarte"},
        {name: "Hängebrücke", Aktion: "Die Hängebrücke kannst du mit vollem Inventar nicht überqueren. Lege Dinge dazu auf ihr Feld zurück." ,type: "Basiskarte"},
        { name: "Kannibalen",  Aktion: "Die Kannibalen durchstreifen das Tal. Wenn ihr den Schrunpfkopf bei euch habt, lassen sie euch vorbeiziehen. Ansonsten könnt ihr das Feld nicht betreten.", info: "problem", type: "Feldkarte" },
        { name: "Kannibalen",  Aktion: "Die Kannibalen durchstreifen das Tal. Wenn ihr den Schrunpfkopf bei euch habt, lassen sie euch vorbeiziehen. Ansonsten könnt ihr das Feld nicht betreten.", info: "problem", type: "Feldkarte" },
        ...
        {name: "Artefakt",  Aktion: "Du findest ein Artefakt der verschollenen Zivilisation. Bringe alle 4 Teile zum Taleingang", imgclass:"symbol",hor: "true",type: "Feldkarte"},
        {name: "Artefakt",  Aktion: "Du findest ein Artefakt der verschollenen Zivilisation. Bringe alle 4 Teile zum Taleingang", imgclass:"symbol",hor: "true",type: "Feldkarte"},
        {name: "Artefakt",  Aktion: "Du findest ein Artefakt der verschollenen Zivilisation. Bringe alle 4 Teile zum Taleingang", imgclass:"symbol",ver: "true",type: "Feldkarte"},
        {name: "Artefakt",  Aktion: "Du findest ein Artefakt der verschollenen Zivilisation. Bringe alle 4 Teile zum Taleingang", imgclass:"symbol",ver: "true",type: "Feldkarte"},
        ...
        {name: "Höhle",  Aktion: "Wenn man die Fackel besitzt, kann man von dieser Höhle direkt zu einer anderen Höhlenkarte ziehen.",ver: "true", info:"info" , bgc:"blue",type: "Feldkarte"},
        {name: "Machete",  Aktion: "Die Machete kann eine Dschungelwand öffnen. Lege die Machete dazu auf die Wand.",ver: "true",imgclass:"symbol",type: "Feldkarte"},
        {name: "Pistole",  Aktion: "Die Pistole ist alt und hat nur noch eine Kugel.",hor: "true",ver: "true", imgclass:"symbol", bgc: "gelb",type: "Feldkarte"},
        ...
        {name: "Schlange",  Aktion: "Die Schlange hat ein tödliches Gift und beisst dich. Lege ein Gegengift hier ab, um vor der Schlange geschützt zu sein.", info:"problem",type: "Feldkarte"},
        {name: "Taleingang",  Aktion: "Mit den 4 Artefakten kannst du den Eingang zum verschollenen Tal öffnen. und beendest Akt II. Lege die Artefakte dazu hier ab.",hor: "true", bgc:"green",type: "Feldkarte"}
    ],
    initActions: [
        ...
        {name: "Gefangen",  Aktion: "Jack wird von den Kannibalen überrascht und gefangen. Jane muss den Kannibalen den Schrumpfkopf geben, dann lassen sie Jack frei. Bis dahin kannst du Jacks Inventarkarte nicht verwenden.",info:"warn", bgc:"orange", win:"Fluss", bgcwin:"blue",task: true,type: "Aktionskarte"},
        {name: "Diamantenmine",  color : "H",Aktion: "Mit der Fackel findest du in der dunklen Mine grosse Diamanten. Wenn du Sie herausholst, verlierst du die Fackel.", info:"warn", win:"Diamantenmine", bgcwin:"green", imgclass:"symbol", task: true,type: "Aktionskarte"},
        {name: "Tiger",  color : "H",Aktion: "Ein Tiger überrascht euch und jagt euch 2 Felder diagonal zur Mitte. Ihr könnt die Aktion auf diesem Feld ignorieren.", task: true,type: "Erweiterung Aktionskarte"},
        {name: "Königin",  color : "H",Aktion: "Jane wird von den Kannibalen als Dschungelkönigin verehrt. Lege mit der Fackel ein Feuer, dann kann Jane unbemerkt fliehen. Die Fackel geht in den Vorrat.", task: true,type: "Erweiterung Aktionskarte"},
        {name: "Schatzkammer", variant:"d", Aktion: "Ihr habt die Schatzkammer der Kannibalen gefunden. Wenn ihr die 4 Artefakte hier ablegt, findet Jane die genaue Beschreibung von El Dorado. Über einen versteckten Höhlenausgang könnt ihr das Tal verlassen. The FIN.", bgc:"orange", win:"Fluss", bgcwin:"blue",task: true,type: "Erweiterung Aktionskarte"},
    ], 
    secondActions: [
    ...
    start: {name: "Akt II", color : "H",  task: true,
